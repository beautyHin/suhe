...
<html lang="en">
  ...
  <div class="admin">
      <div class="panel admin-panel margin-top">
          <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>&nbsp;&nbsp;学生添加</strong></div>
          <div class="body-content">

    <form id="tab" class="form-x" action="${basePath }cms/admin/stu/StudentAdmin/studentInsert.action" method="post" onsubmit="return FormValidator.Validate(this,3)">
