...
<div class="panel admin-panel margin-top">
	<div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>&nbsp;&nbsp;学生旷寝编辑</strong></div>
	<div class="body-content">
						<form id="tab" class="form-x" action="${basePath }cms/teacher/liveout/LiveOut/update.action"
							method="post" onsubmit="return FormValidator.Validate(this,3)">
							<input type="hidden" name="liveoutId" value="${model.liveoutId }" >
							<%@include file="liveout_form.jsp"%>
