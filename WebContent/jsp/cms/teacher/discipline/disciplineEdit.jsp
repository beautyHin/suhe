...
<div class="admin">
	<div class="panel admin-panel margin-top">
		<div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>&nbsp;&nbsp;宿舍违规编辑</strong></div>
		<div class="body-content">
						<form id="tab" class="form-x" action="${basePath }cms/teacher/discipline/Discipline/update.action"
							method="post" onsubmit="return FormValidator.Validate(this,3)">
							<input type="hidden" name="disciplineId" value="${model.disciplineId }" >
