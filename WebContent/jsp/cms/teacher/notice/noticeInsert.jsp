...
<div class="admin">
	<div class="panel admin-panel margin-top">
		<div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>&nbsp;&nbsp;宿舍公告添加</strong></div>
		<div class="body-content">
						<form id="tab"  class="form-x"  action="${basePath }cms/teacher/notice/Notice/insert.action"
